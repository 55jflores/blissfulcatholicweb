...
// - getSupabaseAdmin(): secret key, BYPASSES RLS. Server-only. For webhooks/trusted writes.
...
/** Secret-key client. Full access, bypasses RLS. NEVER import from client code. */
